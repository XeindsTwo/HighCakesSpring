!function (e, t) {
    ...
    var $ = {
        ...
        updateSize: function () {
            ...
            let y = a.spaceBetween, x = -f, E = 0, C = 0;
            if (void 0 === r) return;
            "string" == typeof y && y.indexOf("%") >= 0 && (y = parseFloat(y.replace("%", "")) / 100 * r), e.virtualSize = -y, n ? c.css({
                marginLeft: "",
                marginBottom: "",
                marginTop: ""
            }) : c.css({
            ...
            if (0 === u.length && (u = [0]), 0 !== a.spaceBetween) {
                ...
                c.filter(((e, t) => !a.cssMode || t !== c.length - 1)).css({[s]: `${y}px`})
            }
    ...
    function L(e) {
        ...
        const w = o.currentX, b = o.currentY, y = l.edgeSwipeDetection || l.iOSEdgeSwipeDetection,
    ...
    var X = {
        attachEvents: function () {
            ...
            e.onTouchStart = L.bind(e), e.onTouchMove = O.bind(e), e.onTouchEnd = I.bind(e), s.cssMode && (e.onScroll = G.bind(e)), e.onClick = D.bind(e), i.touch && !B && (t.addEventListener("touchstart", N), B = !0), H(e, "on")
    ...
    class V {
        constructor() {
            ...
            const l = g({}, R, n);
            return r.params = g({}, l, j, t), r.originalParams = g({}, r.params), r.passedParams = g({}, t), r.params && r.params.on && Object.keys(r.params.on).forEach((e => {
    ...
    const re = [function (e) {
        ...
        function l(e) {
            ...
            }), d === w && c === b && !e) return s.slidesGrid !== u && y !== h && s.slides.css(f, `${y}px`), s.updateProgress(), void r("virtualUpdate");
            ...
            })), s.$wrapperEl.children(".swiper-slide").css(f, `${y}px`), x()
        }
        ...
        function C(e) {
            ...
            l.touch ? (d[u](a.start, y, c), d[u](a.move, x, c), d[u](a.end, E, p)) : (d[u](i.start, y, c), n[u](i.move, x, c), n[u](i.end, E, p))
        }
        ...
        function T(e) {
            ...
            let i, r, l, o, c, u, h, g, v, w, b, y, x, E, C, T, $, S;
        ...
        function O() {
            ...
            s.gestures ? (t.$wrapperEl.on(t.touchEvents.start, z, a), t.$wrapperEl.on(t.touchEvents.end, L, a)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.on(t.touchEvents.start, r, b, a), t.$wrapperEl.on(t.touchEvents.move, r, y, i), t.$wrapperEl.on(t.touchEvents.end, r, x, a), t.touchEvents.cancel && t.$wrapperEl.on(t.touchEvents.cancel, r, x, a)), t.$wrapperEl.on(t.touchEvents.move, `.${t.params.zoom.containerClass}`, E, i)
        }
        ...
        function I() {
            ...
            s.gestures ? (t.$wrapperEl.off(t.touchEvents.start, z, a), t.$wrapperEl.off(t.touchEvents.end, L, a)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.off(t.touchEvents.start, r, b, a), t.$wrapperEl.off(t.touchEvents.move, r, y, i), t.$wrapperEl.off(t.touchEvents.end, r, x, a), t.touchEvents.cancel && t.$wrapperEl.off(t.touchEvents.cancel, r, x, a)), t.$wrapperEl.off(t.touchEvents.move, `.${t.params.zoom.containerClass}`, E, i)
        }
        ...
        a("beforeInit", (() => {
            ...
            t.params.a11y.enabled && function () {
                let e, s;
                i && i.length > 0 && i.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (s = t.navigation.$prevEl), e && e.off("keydown", m), s && s.off("keydown", m), g() && t.pagination.$el.off("keydown", U(t.params.pagination.bulletClass), m), t.$el.off("focus", y, !0), t.$el.off("pointerdown", w, !0), t.$el.off("pointerup", b, !0)
            }()
        }))
    }, function (e) {
        let {swiper: t, extendParams: s, on: a} = e;
        ...
        te({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    const x = se(r, a);
                    x.transform(y).css({opacity: b}), f.origin && x.css("transform-origin", f.origin)
                }
            },
            setTransition: e => {
...
const swiperHome = new Swiper(".service__slider", {
    breakpoints: {
        1030: {spaceBetween: 30, speed: 300},
        1180: {speed: 700, slidesPerView: 2, slidesPerGroup: 2, spaceBetween: 40}
    },
    pagination: {el: ".service__pagination", type: "bullets", clickable: !0, dynamicBullets: !1},
    navigation: {nextEl: ".service__btn--next", prevEl: ".service__btn--prev"}
});

document.addEventListener("DOMContentLoaded", (function () {
    const e = document.querySelector(".menu-btn"), t = document.querySelector(".header__nav");
    e.addEventListener("click", (function () {
        t.classList.toggle("header__nav--active")
    }))
}));